...
public class AdopterPosts extends RecyclerView.Adapter<AdopterPosts.MyHolder> {
    ...
    public AdopterPosts(Context context, List<posts> posts) {
        this.context = context;
        this.postref = (DatabaseReference) posts;
        myuid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        liekeref = FirebaseDatabase.getInstance().getReference().child("Likes");
        postref = FirebaseDatabase.getInstance().getReference().child("Posts");
    }

    List<posts> modelPosts;

    @NonNull
    @Override
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.raw_posts, parent, false);
    ...
    private void deltewithImage(final String pid, String image) {
        ...
        ((StorageReference) picref).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
