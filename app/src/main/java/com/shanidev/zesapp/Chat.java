...
public class Chat<onDataChange, onCancelled> extends AppCompatActivity {
    Toolbar toolbar;
    ...
    private RecyclerView.Adapter adopterChat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Object onDataChange;
        onDataChange DataSnapshotdataSnapshot; {
        ...
        onCancelled DatabaseErrordatabaseError; {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (Chat.getSender().equals(myuid) &&
                        ...
                        chatList.add(chat); // add the chat in chatlist
                    }
                    adapterChat = new AdopterChat(Chat.this, chatList, image);
                    adapterChat.notifyDataSetChanged();
                    recyclerView.setAdapter(adopterChat);
                }
            }
    ...
    private static Object getReceiver() {
        return null;
    }
