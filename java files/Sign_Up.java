...
public class Sign_Up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nSignUpBtn.setOnClickListener(view -> {
            ...
            } else if (nSignUpMail.getText().toString().trim().equals("")) {
                nSignUpMail.setError(Sign_Up.this.getString(R.string.mailError));
                nSignUpMail.requestFocus();
            } else if (nSignUpPass.getText().toString().trim().equals("") || nSignUpPass.getText().toString().trim().length() < 8) {
    ...
    private void signNewUser() {
        LoadingDialog loadingDialog = new LoadingDialog(Sign_Up.this);
